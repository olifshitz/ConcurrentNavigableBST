...
import algorithms.deucestm.RBTreeLocks;
 ...
 */
@Exclude
public class RBTreeCoarseLockAdapter<K extends Comparable<? super K>>
extends AbstractAdapter<K>
implements BBSTInterface<K>, SequentialStructure /* placed here simply so that prefilling will be a single threaded process */ {
    RBTreeLocks<K,K> tree;

    public RBTreeCoarseLockAdapter(double rebalance_probability) {
        tree = new RBTreeLocks();
    }
