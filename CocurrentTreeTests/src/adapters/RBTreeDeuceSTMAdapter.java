...
import algorithms.deucestm.RBTreeSTM;
 ...
 */
@Exclude
public class RBTreeDeuceSTMAdapter<K extends Comparable<? super K>>
...
implements BBSTInterface<K>, STMStructure /* placed here simply so that prefilling will be a limited number of processes */ {
    ...
    public RBTreeDeuceSTMAdapter(double rebalance_probability) {
        tree = new RBTreeSTM();
    }
